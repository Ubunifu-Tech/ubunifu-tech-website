 ...
 * The button is just their initials in a circle, in the same colour they
 * have everywhere else; the name, role, email and choices are in the menu.
 */
export function ProfileMenu({
  ...
  return (
    <Popover.Root open={open} onOpenChange={setOpen}>
      <Popover.Trigger className={styles.trigger} aria-label={`Account: ${name}`} title={name}>
